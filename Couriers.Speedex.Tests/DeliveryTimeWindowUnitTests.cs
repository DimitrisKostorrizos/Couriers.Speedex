...
namespace Couriers.Speedex.Tests
{
    ...
    public sealed class DeliveryTimeWindowUnitTests
    {
        ...
        {
            var earlierTime = new DateTime(2000, 2, 2, 10, 0, 0, DateTimeKind.Local);

            var laterTime = new DateTime(2000, 2, 2, 12, 0, 0, DateTimeKind.Local);
        ...
        {
            var startingTime = new DateTime(2000, 2, 2, 10, 0, 0, DateTimeKind.Local);

            var endingTime = new DateTime(2000, 2, 2, 12, 0, 0, DateTimeKind.Local);
        ...
        public void DeliveryTimeWindow_Equality_ExpectedResultsAreReturned()
        {
            ...
            Assert.False(firstDeliveryTimeWindow.Equals(new DeliveryTimeWindow(startingTime, new DateTime(2000, 2, 2, 13, 0, 0, DateTimeKind.Local))));

            Assert.False(firstDeliveryTimeWindow.Equals(new DeliveryTimeWindow(new DateTime(2000, 2, 2, 9, 0, 0, DateTimeKind.Local), endingTime)));
